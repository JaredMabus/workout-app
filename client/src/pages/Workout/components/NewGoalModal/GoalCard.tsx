...
export default function GoalCard({
    ...
    const setCardValues = () => {
        if (activeGoal != null && type === "previous") {
            setValues({
                rounds:
                    activeGoal.targetRounds - workout.targetGoal.setIncrease,
                sets: activeGoal.targetSets - workout.targetGoal.setIncrease,
                weight:
                    activeGoal.targetWeight - workout.targetGoal.weightIncrease,
        ...
        <>
            ...
            >
                ...
                >
                    <Box
                        component="img"
                        src={type === "previous" ? fitnessPlan : TargetGoalIcon}
